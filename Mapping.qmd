...
main_df <- read_csv("inputs/ms5130_w07_sales_by_county.csv", col_types = cols(.default = "c", sales = "d"))
mapping_df <- read_csv("inputs/ms5130_w07_county_mapping.csv", col_types = cols(.default = "c"))
...
write.csv(cleaned_df, "outputs/cleaned_data.csv", row.names = FALSE)
